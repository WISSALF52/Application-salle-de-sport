...
import com.example.demo.repositories.CodePromoRepository;
import com.example.demo.repositories.PaiementRepository;
import com.example.demo.repositories.RemboursementRepository;
import com.reservation.sport.entite.*;
import com.reservation.sport.repositories.*;
...
public class PaiementService {
    ...
    /**
     * Vérifie la validité d'un code promo et l'applique si valide
     */
    ...
    /**
     * Applique la réduction d'un code promo au montant
     */
    private BigDecimal appliquerReduction(BigDecimal montant, CodePromo codePromo) {
        if (codePromo.isEstPourcentage()) {
            ...
            // La réduction ne peut pas être supérieure au montant
            return montant.compareTo(reduction) > 0 ? montant.subtract(reduction) : BigDecimal.ZERO;
        }
    }

    /**
     * Calcule le montant de remboursement en fonction des règles d'annulation
     */
