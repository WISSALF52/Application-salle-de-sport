...
public class UtilisateurController {
    ...
    @PostMapping("/verifier-inscription")
    public ResponseEntity<Utilisateur> verifierOuInscrireUtilisateur(@RequestBody Utilisateur utilisateur) {
        Utilisateur utilisateurInscrit = utilisateurService.verifierOuInscrireUtilisateur(
                utilisateur.getNom(),
